...
"""
from korder.actions import audio_output, base, bluetooth, keys, launcher, media, modes, now_playing, playback_target, shortcuts, spotify, system, text_chars, vision, web, window  # noqa: F401  (self-register)
