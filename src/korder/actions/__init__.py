...
"""
from korder.actions import base, keys, launcher, media, modes, now_playing, playback_target, shortcuts, spotify, system, text_chars, web, window  # noqa: F401  (self-register)
