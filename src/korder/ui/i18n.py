...
_STRINGS: dict[str, dict[str, str]] = {
    "pl": {
        ...
        # Bluetooth connect/disconnect — fuzzy device match against the
        # paired list, audio routing handled by PipeWire wireplumber.
        "progress_bt_no_paired": "Brak sparowanych urządzeń Bluetooth.",
        "progress_bt_none_connected": "Żadne urządzenie Bluetooth nie jest podłączone.",
        "progress_bt_not_found": "Nie znaleziono urządzenia: {query}",
        "progress_bt_connecting": "Łączę z {name}…",
        "progress_bt_connected": "Podłączono {name}",
        "progress_bt_already_connected": "{name} jest już podłączone",
        "progress_bt_connect_failed": "Nie udało się połączyć z {name}",
        "progress_bt_disconnecting": "Rozłączam {name}…",
    ...
    "en": {
        ...
        "progress_bt_no_paired": "No paired Bluetooth devices.",
        "progress_bt_none_connected": "No Bluetooth devices connected.",
        "progress_bt_not_found": "Device not found: {query}",
        "progress_bt_connecting": "Connecting to {name}…",
        "progress_bt_connected": "Connected {name}",
        "progress_bt_already_connected": "{name} is already connected",
        "progress_bt_connect_failed": "Couldn't connect to {name}",
        "progress_bt_disconnecting": "Disconnecting {name}…",
